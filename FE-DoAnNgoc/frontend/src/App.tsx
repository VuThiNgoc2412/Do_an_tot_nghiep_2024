...
const App = () => {
  ...
  const getAuth = () => {
    try {
      ...
      if (res) {
        // Parse dữ liệu nếu tồn tại và hợp lệ
      ...
      // Đảm bảo setIsAuthLoaded luôn được gọi
      setIsAuthLoaded(true); // Đánh dấu đã tải xong auth
    }
  };
      ...
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          <Route
            path="/login"
            element={
              <ProtectedRoute isAuthenticated={auth.accessToken ? false : true}>
                <Login />
              </ProtectedRoute>
            }
          />
